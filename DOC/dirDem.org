...
*** packageManager
https://eth-brownie.readthedocs.io/en/stable/ethpm.html#ethpm
** Đapps
...
https://github.com/eth-brownie/brownie
***** mix
https://github.com/orgs/brownie-mix/repositories
**** truffle                                                          :js:
...
** 10 ERKENNTNISSE
** 11 ERLEDIGTES
*** DONE try to install vyper with poetry
apply
