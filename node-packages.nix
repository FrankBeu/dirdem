...
let
  sources = {
    ...
    "tailwindcss-2.2.16" = {
      ...
      version = "2.2.16";
      src = fetchurl {
        url = "https://registry.npmjs.org/tailwindcss/-/tailwindcss-2.2.16.tgz";
        sha512 = "EireCtpQyyJ4Xz8NYzHafBoy4baCOO96flM0+HgtsFcIQ9KFy/YBK3GEtlnD+rXen0e4xm8t3WiUcKBJmN6yjg==";
      };
    };
    "tmp-0.2.1" = {
      name = "tmp";
